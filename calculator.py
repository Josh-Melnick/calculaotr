...
entry1.grid(row=0,column=0, columnspan=100, padx=10,pady=20)
...
button_clear = Button(root, text='Clear', pady=20, padx=75,  command=button_clear)
...
#myButton = Button(root, text="Enter Your Name", fg="blue", bg="green",  command=delete(0, END))

#myButton.bind(Button-1, myButton.delete(0, END))
